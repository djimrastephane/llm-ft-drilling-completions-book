...
The scripts in this book are the engine. The book's optional companion
app (`book/app/`) is planned to put the same comparison on one screen — a
question, the base model's answer, and the fine-tuned model's answer,
side by side. See [Appendix A](appendix/appendix_a_environment_setup.qmd)
for setup details once it exists.
