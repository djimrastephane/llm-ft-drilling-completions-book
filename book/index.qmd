...
All code, training data, and notebooks referenced in this book will live
in the companion repository. Every chapter will list exactly which files
you need under **Repository files**.

If you've never installed Python or don't know which editor to use, start
with **Part 0 — Preparing Your Local LLM Workshop**: it will work with any
of five common setups (Jupyter Notebook, VS Code, PyCharm Community,
Positron, or a terminal alone) and end with your first script actually
running. If you already have Python and a working setup, jump straight to
Chapter 1 once it exists.
