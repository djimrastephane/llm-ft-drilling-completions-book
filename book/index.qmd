...
scores for each.](figures/app_screenshot_playground.jpg){#fig-app-playground fig-alt="Screenshot of the companion app's Model Playground page, showing a base model answer and a fine-tuned model answer side by side for the same held-out question, each scored for exact-match and overlap against the real reference answer."}
