...
|---|:---:|:---:|
| Teach the model your shorthand and vocabulary? | Yes | No |
| Match your reports' own writing style? | Yes | No |
| Recall one specific fact from one specific report? | No | Yes |
| Cite which source document an answer came from? | No | Yes |
| Answer questions about reports it never trained on? | No | Yes |
| Prove it generalizes, on its own? | No | n/a |
