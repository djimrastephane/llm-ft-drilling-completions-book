...
loaded it into memory. `torch_dtype=torch.float32` is the CPU-safe numeric precision this book
uses throughout, on CPU, GPU, or Apple Silicon alike — Chapter 5 shows
how to move the same full-precision model onto a GPU (`model.to("cuda")`)
if you have one, without changing this precision. (Depending on your
