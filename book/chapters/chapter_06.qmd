...
# Data Quality Gates for Training Data {#sec-chapter-06}
...
three files per diagram: pipeline_ch06_light.svg and _dark.svg (for
HTML), and pipeline_ch06.pdf (for PDF output -- see the note below on
